...
const APIKEY = '5be95af148a0b36497dd2d59fb3435f5'
...
async function getWeather (city, key, units = 'imperial') {
  try {
    ...
    document.body.classList.add(data.weather[0].description.toLowerCase())
    ...
    if (data.weather.main = mist) {
      document.body.classList.add('mist')
    }
    if (data.weather.main = haze) {
